...
example_pokemon = {
    "name" : "알로라 디그다",
    "types" : ["땅", "강철"],
    "image_url" : "https://i.namu.wiki/i/XWm_70InQlCnHsjKy4klgA3F1nCnBWNL_nAPvvXQpXYd4HBZfEJsT66n8WbsbBy0qI8-DPqFl3n-ZdEyGSB2yQx3p0HOTO9SYvDtL7DgtKhtKfZdYpvuxhfQjeLE1NG4idsXeLgA4iK9sF683biPww.webp"
}

auto_complete = st.toggle("예시 데이터")
print("page_reolad, auto_complete", auto_complete)
    ...
    for j in range(len(row_pokemons)):
        with cols[j]:
            ...
            with st.expander(label=f"**{i + j + 1}. {pokemon['name']}**", expanded=True):
                ...
                emoji_types = [f"{x} {type_emoji_dict[x]}" for x in pokemon["types"]]
